...
public class TC_004_AccountRegressionTest extends BaseClass_Regression
{
	@Test(groups= {"Regression","Master"}) //Step8 groups added
	public void test_account_Registration() throws InterruptedException
	{		
		logger.info("Strating TC_004_AccountRegressionTest");
		try {
		...
		logger.info("Finished TC_004_AccountRegressionTest");
	}
